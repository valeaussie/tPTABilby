...
def get_tspan_fundamental_freq(psrs):
    ...
    print(np.min(toamins))
    print(np.max(toamaxs))
...
def get_crn_model_dict(tspan):
    ...
    crn_model_dict = {
        ...
        'pl_nocorr_freegam': crn_block(psd='powerlaw', prior='log-uniform', gamma_val=None, Tspan=tspan,
        ...
        'pl_hd_freegam': crn_block(psd='powerlaw', prior='log-uniform', Tspan=tspan,
