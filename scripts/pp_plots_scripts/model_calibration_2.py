...
pvalue_dir = "/fred/oz005/users/vdimarco/tBilby/results/300_sims_tight_uniforms_2/p_values"
num_bins = 10
...
plt.xlabel('Posterior probability assigned to a model', fontsize=14)
plt.ylabel('Fraction of times that model was correct', fontsize=14)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.legend(fontsize=12)
plt.grid(True)
plt.tight_layout()
plt.savefig("posterior_model_calibration_2.pdf", bbox_inches="tight")
